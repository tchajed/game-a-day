...
Open the **Hiker** model viewer from the top-right control to orbit and inspect the fully procedural Trail Scout: red jacket, knit cap, sturdy boots, and a connected classic backpack with a small mountain badge. The viewer is also available directly at `/hike/character.html`.
